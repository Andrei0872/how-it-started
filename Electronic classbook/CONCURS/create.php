...
<button type="submit" class="w3-button w3-block w3-section w3-green w3-ripple w3-padding" style="border-radius:10px;">Trimite</button>
    ...
    <div class="w3-container w3-right">
            ...
            <a href="cls9.php" class="w3-btn w3-right w3-green w3-round-xxlarge"> Pagina Precedenta </a>
       
        <div class="w3-rest w3-margin"></div>   
        <br>
       
        
            <a href="w3csadmin.php" class="w3-btn w3-right w3-blue w3-round-xxlarge"> Pagina Principala </a>
