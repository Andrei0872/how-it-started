...
<body>
   <div class="w3-container w3-margin w3-padding w3-responsive">
       <h3 class="w3-center">Inserare note pentru elevul <?php echo ucfirst($result[0]['nume']); echo " "; echo ucfirst($result[0]['prenume']);?></h3>
       <div ng-app="myApp" ng-controller="myCtrl">
           <form  id="add_form"> <!-- name pt serialize-->
               ...
               <tr id="1">
                   ...
                   <td><input style="border:none;width:135px;height:40px;border-radius:20px;" class="dati" type="text"   placeholder="Date"></td>
